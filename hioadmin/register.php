<?php
  ...
  if (isset($_SESSION['username']) || isset($_COOKIE['hio_session_id'])) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql_insert = mysqli_query($con,"INSERT INTO `tbl_user`(`user_name`,`user_email`, `user_password`)
