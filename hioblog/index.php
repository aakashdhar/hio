...
<html lang="en">
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item active" href="../hioadmin/index.php">View Hio Admin</a>
          <?php if (isset($_COOKIE['hio_session_id'])): ?>
    ...
    <script src="../hioadmin/bootstrap/js/bootstrap.min.js"></script>
